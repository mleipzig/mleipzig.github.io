function scrambleTextAnimation(container, targetText, charSet, flipProbability) {
...
if (text) {
    scrambleTextAnimation(text, "Hello, I'm Matthew Leipzig!", "@#&$", 0.2);
    scrambleTextAnimation(emoji, "👋", "🤚🖐✋🖖👌🤌🤏✌🤞🫰🤙🫵👍👎👊🤜🤛🫳🫴👏🙌👐🤲🙏🤝", 0.1)
} else
